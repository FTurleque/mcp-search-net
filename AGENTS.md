...
- Gouvernance du dépôt : `mcp-search-net` est maintenu par un seul développeur. L'absence de branch protection/ruleset sur `develop` est volontaire et hors périmètre ; ne jamais la remonter comme finding d'audit ni la modifier sauf demande explicite de l'utilisateur.
