...
describe('HTML extraction adversarial performance', () => {
  it('handles a large sequence of unclosed noisy containers without quadratic rescanning', () => {
  ...
  it('handles a large sequence of unclosed headings without lazy whole-document regex backtracking', () => {
