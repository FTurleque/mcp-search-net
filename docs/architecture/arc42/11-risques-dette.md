...
| R05 | **Contrat MCP client** : cinq clients restent non certifiés par observation réelle (issue #34)                                                   | Moyenne        | Moyen  | Moyenne    | Certification native ouverte séparément ; cinq outils sont le contrat portable principal                               | Auteur       | Non planifié          |
...
| D02 | **Certification native des 5 clients MCP ouverte** (issue #34) : la preuve STDIO ne remplace pas l'observation réelle de chaque client                                                    | Moyen  | Moyen                | Moyenne                        |
